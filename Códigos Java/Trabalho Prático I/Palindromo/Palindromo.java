...
class Palindromo{
        ...
        try{
            ...
            while(leitor.hasNextLine()){
                ...
                System.out.println("Linha " + line + " é palindromo? ");
    ...
    /**
     * Método para descobrir se a String é palindromo
     * @param s String a ser testada
     * @return  retorna true, caso for palindromo, ou false, caso não for palindromo
     */
