...
public class SelectionSort{
    public static void main(String[] args)throws Exception{
        ...
        //Leitura do input        
        try{
            File input = new File("./Códigos Java/Programação Orientada a Objetos(POO)/Selection Sort/pubSelectionSort.in");
        ...
        System.out.println("******************************************************************************************************************************************************");
        System.out.println("Lista sem passar pela Selection Sort: ");
        list.Show();

        System.out.println("******************************************************************************************************************************************************");

        System.out.println();
        System.out.println("Lista apos passar pela Selection Sort: ");
        list.Selection();
        list.Show();
    }
}
    ...
    */
    ...
    public void Selection(){
        for(int i = 0; i < (x - 1); i++){
            ...
            for(int j = (i + 1); j < x; j++){
                if((array[menor].getPaginaTam()) - (array[j].getPaginaTam()) == 0 ){
			        if (array[menor].getNome().compareToIgnoreCase(array[j].getNome()) > 0) 
                        menor = j;
				}
				else if ((array[menor].getPaginaTam()) - (array[j].getPaginaTam()) > 0 )
                    menor = j;
			}
			Swap(menor, i);
        }
    ...
    /**
     * Método para fazer uma troca de posição entre dois elementos (Swap)
     * @param menor o menor valor 
     * @param i o valor para ser trocado com o menor valor
     */
    public void Swap(int menor, int i){
        Time temp = array[menor];
        array[menor] = array[i];
        array[i] = temp;
    }
