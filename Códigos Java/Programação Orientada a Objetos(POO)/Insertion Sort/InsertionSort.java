...
public class InsertionSort{
    public static void main(String[] args)throws Exception{
        ...
        //Leitura do input        
        try{
            File input = new File("./Códigos Java/Programação Orientada a Objetos(POO)/Insertion Sort/pubInsertionSort.in");
        ...
        System.out.println("******************************************************************************************************************************************************");
        System.out.println("Lista sem passar pelo Insertion Sort: ");
        list.Show();

        System.out.println("******************************************************************************************************************************************************");

        System.out.println();
        System.out.println("Lista apos passar pelo Insertion Sort: ");
        list.Insercao();
        list.Show();
    }
}
    ...
    public void Insercao(){
		for(int i = 1; i < x; i++){
        	...
        	int j = i - 1;
         	...
         	while((j >= 0) && ((array[j].getFundacaoAno()) - (temp.getFundacaoAno())) > 0){
				array[j + 1] = array[j];
				j--;
			}
